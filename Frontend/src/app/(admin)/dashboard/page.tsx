  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-white/90 tracking-tight">Dashboard</h1>
          <p className="text-[13px] text-white/30 mt-0.5">Your workspace overview</p>
        </div>
        <div className="flex items-center gap-2">
          <button
            onClick={() => setPersonalizationOpen(true)}
            className="px-4 py-2 text-[12px] font-medium rounded-xl border border-white/[0.06] bg-white/[0.03] text-white/50 hover:text-white/70 hover:bg-white/[0.06] hover:border-white/[0.1] transition-all duration-200"
          >
            Theme
          </button>
          <button
          ...
          <button
            ...
            className={`px-4 py-2 text-[12px] font-medium rounded-xl border transition-all duration-200 ${
              editMode
                ...
                : "border-white/[0.06] bg-white/[0.03] text-white/50 hover:text-white/70 hover:bg-white/[0.06]"
            }`}
          >
