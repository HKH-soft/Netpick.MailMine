...
export default function StatisticsPage() {
  return (
    <div>
      ...
      <div className="min-h-[400px] flex items-center justify-center rounded-2xl border border-gray-200 bg-white px-5 py-7 dark:border-gray-800 dark:bg-gray-900 xl:px-10 xl:py-12">
