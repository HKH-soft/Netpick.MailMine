...
const footerSections = [
  {
    title: "Platform",
    links: [
      { name: "Email Scraping", href: "/solutions/scraping" },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 md:gap-12 mb-12">
          <div className="col-span-2">
            ...
            >
              Advanced email intelligence platform for modern teams.
            </p>
          </div>
        ...
        >
          <div className="flex items-center gap-3 mb-4 md:mb-0">
            {socialLinks.map((social) => (
              <a
                key={social.name}
                href={social.href}
                className="p-2 rounded-lg transition-all duration-300 hover:text-white"
                style={{ color: "var(--color-text-muted)" }}
          ...
          <p className="text-[12px]" style={{ color: "var(--color-text-faint)" }}>
            © {new Date().getFullYear()} Netpick. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
