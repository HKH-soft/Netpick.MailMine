...
import { CheckCircleSuccessIcon, InfoCircleIcon, WarningCircleIcon, ErrorCircleIcon } from "@/icons";
  ...
  return (
    <ComponentCard title="Modal Based Alerts">
      ...
      <Modal
        ...
        onCloseAction={successModal.closeModal}
        className="max-w-[600px] p-5 lg:p-10"
      >
        <div className="text-center">
          <div className="relative flex items-center justify-center z-1 mb-7">
            <div className="fill-success-50 dark:fill-success-500/15">
              <svg
                width="90"
                height="90"
                viewBox="0 0 90 90"
            ...
            <span className="absolute -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2">
              <CheckCircleSuccessIcon className="fill-success-600 dark:fill-success-500" />
            </span>
          </div>
      ...
      <Modal
        ...
        onCloseAction={infoModal.closeModal}
        className="max-w-[600px] p-5 lg:p-10"
      >
        <div className="text-center">
          <div className="relative flex items-center justify-center z-1 mb-7">
            <div className="fill-brand-50 dark:fill-brand-500/15">
              <svg
                width="90"
                height="90"
                viewBox="0 0 90 90"
            ...
            <span className="absolute -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2">
              <InfoCircleIcon className="fill-brand-500 dark:fill-brand-500" />
            </span>
          </div>
      ...
      <Modal
        ...
        onCloseAction={warningModal.closeModal}
        className="max-w-[600px] p-5 lg:p-10"
      >
        <div className="text-center">
          <div className="relative flex items-center justify-center z-1 mb-7">
            <div className="fill-warning-50 dark:fill-warning-500/15">
              <svg
                width="90"
                height="90"
                viewBox="0 0 90 90"
            ...
            <span className="absolute -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2">
              <WarningCircleIcon className="fill-warning-600 dark:fill-orange-400" />
            </span>
          </div>
      ...
      <Modal
        ...
        onCloseAction={errorModal.closeModal}
        className="max-w-[600px] p-5 lg:p-10"
      >
        <div className="text-center">
          <div className="relative flex items-center justify-center z-1 mb-7">
            <div className="fill-error-50 dark:fill-error-500/15">
              <svg
                width="90"
                height="90"
                viewBox="0 0 90 90"
            ...
            <span className="absolute -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2">
              <ErrorCircleIcon className="fill-error-600 dark:fill-error-500" />
            </span>
          </div>
