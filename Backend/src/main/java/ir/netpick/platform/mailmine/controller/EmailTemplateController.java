...
import ir.netpick.platform.mailmine.repository.EmailTemplateRepository;
import ir.netpick.platform.mailmine.service.TemplateRenderService;
...
@RestController
@RequestMapping("/api/v1/mailmine/email-templates")
