...
import ir.netpick.platform.mailmine.repository.PipelineRepository;
...
public class PipelineService {
    ...
    public java.util.Map<String, Long> getStats() {
        ...
        return java.util.Map.of(
                ...
                "active",
                pipelineRepository
                        .countByStateAndDeletedFalse(ir.netpick.platform.core.enums.PipelineStateEnum.RUNNING),
                "completed",
                pipelineRepository
                        .countByStateAndDeletedFalse(ir.netpick.platform.core.enums.PipelineStateEnum.COMPLETED),
                "failed",
                pipelineRepository
                        .countByStateAndDeletedFalse(ir.netpick.platform.core.enums.PipelineStateEnum.FAILED),
